    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MembershipPlanCenters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MembershipPlanCenters_Centers_CenterId",
                        column: x => x.CenterId,
                        principalTable: "Centers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MembershipPlanCenters_MembershipPlans_MembershipPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Memberships_Centers_CenterId",
                        column: x => x.CenterId,
                        principalTable: "Centers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainerCenterAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrainerCenterAssignments_Centers_CenterId",
                        column: x => x.CenterId,
                        principalTable: "Centers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TrainerCenterAssignments_TrainerProfiles_TrainerProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MembershipPlanCenters_CenterId",
                table: "MembershipPlanCenters",
                column: "CenterId");

            migrationBuilder.CreateIndex(
                name: "IX_MembershipPlanCenters_MembershipPlanId_CenterId",
                table: "MembershipPlanCenters",
                columns: new[] { "MembershipPlanId", "CenterId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Memberships_CenterId",
                table: "Memberships",
                column: "CenterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainerCenterAssignments_CenterId",
                table: "TrainerCenterAssignments",
                column: "CenterId");

            migrationBuilder.CreateIndex(
                name: "IX_TrainerCenterAssignments_TrainerProfileId_CenterId",
                table: "TrainerCenterAssignments",
                columns: new[] { "TrainerProfileId", "CenterId" },
                unique: true);
